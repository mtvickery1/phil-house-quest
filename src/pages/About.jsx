      ...
      <div className="max-w-4xl mx-auto">
        <div className="card p-8 sm:p-12 mb-12">
          <div className="flex flex-col md:flex-row gap-8 items-start">
            <div className="w-full md:w-1/3 aspect-square rounded-2xl overflow-hidden bg-gradient-to-tr from-primary-400 to-accent-400 p-1">
              <div className="w-full h-full rounded-2xl bg-slate-900">
                <img 
                  src="/react-portfolio/me.jpeg" 
                  alt="Mason Vickery" 
