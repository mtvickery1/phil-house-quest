...
export default function Navbar() {
  ...
  return (
    ...
    >
      {/* Update banner - inside the fixed header */}
      <div className="bg-red-600 text-white py-2 px-4 text-center font-mono text-sm font-bold uppercase tracking-wider shadow-lg">
        ✨ UPDATED: HashRouter + Pong Removed + Fixed Routing — {import.meta.env.BUILD_TIMESTAMP}
      </div>
